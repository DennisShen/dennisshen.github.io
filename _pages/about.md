...
I have extensive experience across a broad range of machine learning paradigms, including 3D engine–based data synthesis, sim-to-real adaptation, generative modeling (e.g., GANs and diffusion models), vision-language models (VLMs such as CLIP), and multimodal large language models (LLMs). Representative projects include:
...
<div style="display: flex; align-items: flex-start; margin-top: 20px; margin-bottom: 20px; position: relative;" id="autocompose">
  ...
  <div>
    ...
    <p style="margin: 0; font-size: 0.8em; color: #c3c3c3;">
